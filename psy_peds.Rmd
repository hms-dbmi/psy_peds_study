...
We will generate this table using as input 2.2 data, specifically the files:
- localpatientsummary
- localpatientobservation
- localpatientclinicalcourse

We select only those patients that got at least one of the mental health ICD codes
...
```{r}
# filter by date, to meet the inclusion criteria
cut_off_date <- "2021-04-01"
dateFormat <- "%d-%b-%y"
# check the format of the dates is the the expected one

# breaks by week and add the concept description and group
